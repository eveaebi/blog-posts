...
You should ask yourself: "Can I render this page **ahead** of a user's request?"
If the answer is yes, then you should choose Static Generation.

<CustomImage
	src='https://raw.githubusercontent.com/eveaebi/blog-posts/tree/master/Images/Google-Wallpapers-Free.jpg'
...
pre-rendered page will be up-to-date. Or you can skip pre-rendering and use
